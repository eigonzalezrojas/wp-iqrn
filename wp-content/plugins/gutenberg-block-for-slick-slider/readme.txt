...
Just add a new Slick Slider Block and start creating your own designs.
...
* Fixed: Block validation error
* Fixed: Responsive settings reset problem
...
= 1.0.9 =
* Successfully tested with WordPress version 6.5
